export const navItems = [
  { path: '/dashboard', label: 'Dashboard', iconColor: '#7C3AED', iconName: 'Dashboard' },
  { path: '/chat', label: 'Chat', iconColor: '#8B5CF6', iconName: 'Chat' },
  { path: '/quiz', label: 'Quiz', iconColor: '#84CC16', iconName: 'Quiz' },
  { path: '/upload', label: 'Upload', iconColor: '#F97316', iconName: 'Upload' },
  { path: '/library', label: 'Library', iconColor: '#EF4444', iconName: 'Library' },
  { path: '/games', label: 'Games', iconColor: '#EAB308', iconName: 'Games' },
  { path: '/knowledge-graph', label: 'Knowledge Graph', iconColor: '#14B8A6', iconName: 'Knowledge Graph' },
  { path: '/analytics', label: 'Analytics', iconColor: '#60A5FA', iconName: 'Analytics' },
  { path: '/ml-monitor', label: 'ML Monitor', iconColor: '#F472B6', iconName: 'ML Monitor' },
  { path: '/settings', label: 'Settings', iconColor: '#3B82F6', iconName: 'Settings' },
];
...
export const iconPaths = {
    ...
    'ML Monitor': "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-6h2v6zm4 0h-2V7h2v10z",
